...
class StudentSpinAdapter(context: Context, textViewResourceId: Int, private val values: ArrayList<DCStudents>, private val colors : Int) : ArrayAdapter<DCStudents>(context, textViewResourceId, values) {
